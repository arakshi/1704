...
- demo-пользователи.
- demo-документы (10 шт.) с тестовыми сканами в `uploads/`.
...
## Админка: demo-данные
Кнопка «Создать demo-данные» в админке создает не только пользователей,
но и демонстрационные документы со сканами, чтобы реестр бухгалтера сразу был заполнен.
